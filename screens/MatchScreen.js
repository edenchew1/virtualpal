    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <Text style={styles.instructions}>    
                    We seek for your cooperation in maintaining confidentiality, thank you.
                    {'\n'}
                </Text>
                <Button
                ...
                <Overlay visible={this.state.modalVisible} onClose={this.onClose} closeOnTouchOutside
                    animationType="zoomIn" containerStyle={{ backgroundColor: 'lightslategrey' }}
