    ...
    render() {
        return (
            <ScrollView style={styles.container}>
                <Formik
                    initialValues={{ q1: '', q2: '', q3: '', q4: '', q5: '', q6: '', q7: '', q8: '' }}
                    onSubmit={(values) => {
                ...
                >
                    {(props) => (
                        <View>
                            ...
                            />
                            <Text style={styles.question}>What do you like to do during your free time?</Text>
                            <DropDownPicker
                                items={[
                                    { label: 'Watch films/drama', value: 'watch films/drama' },
                                    { label: 'Spending time with their family and friends', value: 'spending time with their family and friends' },
                                    { label: 'Reading', value: 'reading' },
                                    { label: 'Volunteer Work', value: 'volunteer work' },
                                    { label: 'Cleaning', value: 'cleaning' },
                                    { label: 'Sleeping', value: 'sleeping' },
                                    { label: 'Surfing the internet', value: 'surfing the internet' },
                            ...
                            />
                            <Text style={styles.question}>How do friends usually describe you as? (Choose Top 3)</Text>
                            <DropDownPicker
                                items={[
                            ...
                            />
                            <Text style={styles.question}>Are you an introvert/extrovert?</Text>
                            <DropDownPicker
                                items={[
                            ...
                            />
                            <Text style={styles.question}>What is your nickname in school? </Text>
                            <TextInput
                                style={styles.input}
                            ...
                            />
                            <Text style={styles.question}>What is your biggest pet peeve?</Text>
                            <TextInput
                                style={styles.input}
                                maxLength={100}
                            ...
                            />
                            <Text style={styles.question}> Name your favorite place on Earth.</Text>
                            <TextInput
                                style={styles.input}
                                maxLength={100}
                            ...
                            <Text style={styles.question}> Which country do you want to travel to?</Text>
                            <TextInput
                                style={styles.input}
                                maxLength={100}
                            ...
                            <Text style={styles.question}> What are some of your bad habits?</Text>
                            <TextInput
                                multiline
                                style={styles.input}
                                maxLength={200}
                            ...
                            <Text style={styles.question}> Name 3 of your favorite movies/books.</Text>
                            <TextInput
                                style={styles.input}
                                maxLength={200}
                            ...
                            <Button title='submit' color='grey' onPress={props.handleSubmit} />
